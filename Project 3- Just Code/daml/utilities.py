...
def make_reproducible (seed):
    ...
    print(f"Making reproducible with seed {seed}. Please note that running in parallel (e.g. by setting `n_jobs > 1` in certain scikit-learn functions) breaks reproducibility.")
